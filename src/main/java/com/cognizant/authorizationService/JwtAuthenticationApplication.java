...
/**
 * 
 * POD 3 -Claims Management System , This is the application class for
...
public class JwtAuthenticationApplication {
    ...
    public void initUsers() {
        List<MyUser> users = Stream.of(
               new MyUser("1","Musheer","Musheer"),
               new MyUser("2","Prateek","Prateek"),
               new MyUser("3","Chandeshwar","Chandeshwar"),
               new MyUser("4","Nirbhay","Nirbhay"),
               new MyUser("5","Anish","Anish"),
               
               new MyUser("6","admin","admin")
